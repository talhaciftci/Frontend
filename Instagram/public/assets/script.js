    ...
    posts.forEach((post) => {
      postCard += `
          ...
          <div class="w-11 h-11 p-0.5 rounded-full border-2 border-red-600">
            <a href="#"><img class="w-full h-full rounded-full border object-cover" src="./assets/images/channels4_profile.jpg" alt=""></a>
          </div>
            <a class="text-black text-sm font-semibold hover:underline" href="#">bocekhanedanligi</a>
          </div>
          ...
          <div class="flex flex-auto items-center space-x-1">
            <a href="" class="text-sm font-semibold hover:underline">bocekhanedanligi</a>
